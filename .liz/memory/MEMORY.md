...
- [Engine contracts (closed enums, registries, need calculators)](engine-contracts.md)
  ...
  - [2026-09-11 · pattern · #636](#2026-09-11--pattern--636) — keywords: one direction of a grammar, inverse of resolve_strips, classes_from_strips, strips to classes, fixed class_a/b/c list, define through the forward call, split-B panel
...
- [Making a user-facing marking survive](user-facing-markings.md)
  ...
  - [2026-09-11 · pattern · #630](#2026-09-11--pattern--630) — keywords: not applicable vs absent, registry fact, asset_class, stated absence, section hides itself, parsed not filed
