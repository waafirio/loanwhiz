...
committed, no offline engine series earns the `validated` cell, and 3 of those 29
lines are engine-computed while 26 are report-supplied (Limitation 1). It has
