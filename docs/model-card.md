...
contributes a graded covenants row and no validation figure below. Unvalidated
here means no validation builder is committed and no published-PoP reconciliation
is performed — not that its published actuals are unobtainable. Extraction quality
