...
1,820,150.42 of the report's stated available revenue. Two of its steps are now
independently computed and both reproduce their published figures (#511/#512/#528);
the shortfall is the published rows that join no cascade step at all. The cell
would not have turned green either way.
